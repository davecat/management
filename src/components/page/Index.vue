    ...
    export default {
        ...
        methods: {
            ...
            getWeekData() {
                ...
                this.axios.post('/api/getAmountByDate',{'startDay':weekStart,'endDay':weekEnd,'id':this.staff.id}).then((res) => {
            ...
            getMonthData() {
                ...
                this.axios.post('/api/getAmountByDate',{'startDay':monthStart,'endDay':monthEnd,'id':this.staff.id}).then((res) => {
                    this.lineOption.series = [
                        {
                            name:'总申请量',
                            type:'line',
